...
def parse_args():
    ...
    parser.add_argument('--attribute-list', type=str, default='Male,Skin_tone,Age', help='input the attributes that you want to debias, separated by commas. Eg, Male,Eyeglasses,...')
    parser.add_argument('--prompt', type=str, default='a headshot of a person', help='the text prompt that you want to debias. e.g., use "A natural scene" if you want to use LHQ.')
    parser.add_argument('--prompt-gen', type=str, default='a headshot of a person',
    ...
    parser.add_argument('--checkpoints-path', type=str, default='./ckpts', help='path to save the checkpoints')
    ...
    parser.add_argument('--device', type=int, default=5, help='gpu number')
...
if __name__ == '__main__':
    ...
    folder_name = args.prompt.replace(' ', '_')
    for attr in iti_gen.attribute_list:
        folder_name += ('_' + attr)
    folder_path = os.path.join(args.checkpoints_path, folder_name)
