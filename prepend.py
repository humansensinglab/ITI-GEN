...
def parse_args():
    ...
    parser.add_argument('--attribute-list', type=str, default='Male,Skin_tone,Age',
...
if __name__ == '__main__':
    ...
    for attr in iti_gen.attribute_list:
        folder_name += ('_' + attr)
    folder_path = os.path.join(args.ckpt_path, folder_name)

    # load model
    for idx, attr in enumerate(iti_gen.attribute_list):
        ...
        iti_gen.fairtoken_model_list[idx].load_state_dict(state, strict=False)
        iti_gen.fairtoken_model_list[idx].eval()
